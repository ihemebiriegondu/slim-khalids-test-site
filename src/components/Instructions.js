    ...
    return (
        <div className='pb-5'>
            ...
            <div className='col-11 m-auto mt-5'>
                ...
                <button className='btn start-btn rounded rounded-0 px-5 py-3 mt-4 mb-5' id='' onClick={(e) => chooseUniversity(e)}>Start</button>
            </div>
            <p className='ms-3'><span id='attempt'>2</span> attempts left</p>
        </div>
    )
}
